...
import { FaFacebook, FaTwitter, FaInstagram, FaTiktok, FaPinterest } from 'react-icons/fa'; // Import social media icons
      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <div className="social-icons">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer"><FaYou /></a>
