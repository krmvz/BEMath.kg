...
import AsideBar from '../asideBar/asideBar'; // Import the AsideBar component
...
const Math = () => {
  ...
  const [isAsideBarOpen, setAsideBarOpen] = useState(false); // Track aside bar visibility
  ...
  const mathVideos = [
    ...
    { id: 3, url: 'https://www.youtube.com/watch?v=example2', title: 'Geometry Explained', description: 'Exploring key principles in geometry.' },
  ...
  const toggleAsideBar = () => {
    setAsideBarOpen(!isAsideBarOpen);
  };
  ...
  return (
    <div>
     ...
     <Header/>
     {/* Button to toggle the AsideBar */}
     <button className="aside-bar-toggle" onClick={toggleAsideBar}>
        ☰
      </button>
      <AsideBar isOpen={isAsideBarOpen} />
