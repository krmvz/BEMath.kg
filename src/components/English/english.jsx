...
import './english.scss'; // Assuming you have a separate CSS file for English
...
const English = () => {
  ...
  const englishVideos = [
    { id: 1, url: 'https://www.youtube.com/watch?v=NybHckSEQBI', title: 'Introduction to Literature', description: 'An overview of literary concepts and analysis.' },
    { id: 2, url: 'https://www.youtube.com/watch?v=example2', title: 'Grammar Essentials', description: 'Exploring key principles in English grammar.' },
  ];
  ...
  const handleSubmitHomework = (videoId) => {
    ...
    newSubmittedHomework[videoId] = `Homework for "${englishVideos.find(video => video.id === videoId).title}" (Submitted at ${currentTime}): ${homework}`;
